                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Warga</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahWarga)); ?></div>
                            <div class="mt-2">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Pengguna Sistem</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahUser)); ?></div>
                            <div class="mt-2">
                                <span class="text-success text-sm font-weight-bold">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Kartu Keluarga</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahKK)); ?></div>
                            <div class="mt-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahAnggota)); ?></div>
                            <div class="mt-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Kelahiran</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahKelahiran)); ?></div>
                            <div class="mt-2">
                                <span class="text-info text-sm font-weight-bold">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                Kematian</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahKematian)); ?></div>
                            <div class="mt-2">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Pindah</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(number_format($jumlahPindah)); ?></div>
                            <div class="mt-2">
                                <span class="text-warning text-sm font-weight-bold">
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 py-3">
                            ...
                            <span class="badge bg-primary rounded-pill">
                                <?php echo e($jumlahKK > 0 ? round($jumlahAnggota / $jumlahKK, 1) : 0); ?>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 py-3">
                            ...
                            <span class="badge bg-info rounded-pill">
                                <?php echo e(round($jumlahKelahiran / 12, 1)); ?>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 py-3">
                            ...
                            <span class="badge bg-danger rounded-pill">
                                <?php echo e(round($jumlahKematian / 12, 1)); ?>
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 py-3">
                            ...
                            <span class="badge <?php echo e(($jumlahKelahiran - $jumlahKematian) >= 0 ? 'bg-success' : 'bg-danger'); ?> rounded-pill">
                                <?php echo e($jumlahKelahiran - $jumlahKematian); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="badge badge-<?php echo e($event['color']); ?>"><?php echo e($event['type']); ?></span>
                                    </td>
                                    <td>
                                        <div class="font-weight-bold"><?php echo e($event['name']); ?></div>
                                        <small class="text-muted"><?php echo e($event['detail']); ?></small>
                                    </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const chartData = {
        ...
        datasets: [{
            label: 'Jumlah Data',
            data: [
                <?php echo e($jumlahWarga); ?>,
                <?php echo e($jumlahUser); ?>,
                <?php echo e($jumlahKK); ?>,
                <?php echo e($jumlahAnggota); ?>,
                <?php echo e($jumlahKelahiran); ?>,
                <?php echo e($jumlahKematian); ?>,
                <?php echo e($jumlahPindah); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\alfiqlaravel\laragon-6.0-minimal\www\kependudukan-admin\resources\views/dashboard.blade.php ENDPATH**/ ?>