...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('peristiwa_kelahiran.update', $kelahiran->kelahiran_id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <select name="warga_id" class="form-select" required>
                        ...
                        <?php $__currentLoopData = $anakList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($anak->warga_id); ?>" <?php echo e($kelahiran->warga_id == $anak->warga_id ? 'selected' : ''); ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="ayah_warga_id" class="form-select" required>
                        ...
                        <?php $__currentLoopData = $ayahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ayah->warga_id); ?>" <?php echo e($kelahiran->ayah_warga_id == $ayah->warga_id ? 'selected' : ''); ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="ibu_warga_id" class="form-select" required>
                        ...
                        <?php $__currentLoopData = $ibuList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ibu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ibu->warga_id); ?>" <?php echo e($kelahiran->ibu_warga_id == $ibu->warga_id ? 'selected' : ''); ?>>
                                <?php echo e($ibu->nama); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tgl_lahir" class="form-control" value="<?php echo e($kelahiran->tgl_lahir); ?>" required>
                </div>

                
                <div class="mb-3">
                    <label class="form-label">Tempat Lahir</label>
                    <input type="text" name="tempat_lahir" class="form-control" value="<?php echo e($kelahiran->tempat_lahir); ?>" required>
                </div>

                
                <div class="mb-3">
                    <label class="form-label">Nomor Akta</label>
                    <input type="text" name="no_akta" class="form-control" value="<?php echo e($kelahiran->no_akta); ?>" required>
                </div>
