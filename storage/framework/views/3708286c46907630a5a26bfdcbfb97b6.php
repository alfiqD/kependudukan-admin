<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <!-- Tombol Tambah Data -->
        <a href="<?php echo e(route('peristiwa_kelahiran.create')); ?>"
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->ayah->nama ?? '-'); ?></td>
                                    <td><?php echo e($item->ibu->nama ?? '-'); ?></td>
                                    <td><?php echo e($item->anak->nama ?? '-'); ?></td>
                                    <td><?php echo e($item->anak->jenis_kelamin ?? '-'); ?></td>
                                    <td><?php echo e($item->tgl_lahir); ?></td>
                                    <td><?php echo e($item->tempat_lahir); ?></td>
                                    <td><?php echo e($item->no_akta); ?></td>
                                    <td>
                                        <!-- Tombol Detail -->
                                        <a href="<?php echo e(route('peristiwa_kelahiran.show', $item->kelahiran_id)); ?>"
                                            class="btn btn-info btn-sm d-inline-flex align-items-center gap-1">
                                            <ion-icon name="eye-outline"></ion-icon> Detail
                                        </a>

                                        <!-- Tombol Edit -->
                                        <a href="<?php echo e(route('peristiwa_kelahiran.edit', $item->kelahiran_id)); ?>"
                                            class="btn btn-warning btn-sm d-inline-flex align-items-center gap-1">
                                            <ion-icon name="create-outline"></ion-icon> Edit
                                        </a>

                                        <!-- Tombol Hapus -->
                                        <form action="<?php echo e(route('peristiwa_kelahiran.destroy', $item->kelahiran_id)); ?>"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\alfiqlaravel\laragon-6.0-minimal\www\kependudukan-admin\resources\views/pages/peristiwa_kelahiran/index.blade.php ENDPATH**/ ?>