                            ...
                            <div class="flex flex-wrap gap-4 mt-6">
                                <?php $__currentLoopData = [
                                    ...
                                    <div class="flex items-center gap-2 text-sm text-gray-600">
                                        <i class="<?php echo e($item['icon']); ?> text-blue-500"></i>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <?php $__currentLoopData = [
                                ...
                                <a href="<?php echo e($social['url']); ?>"
                                   target="<?php echo e($social['text'] == 'Pekanbaru' ? '_blank' : '_self'); ?>"
                                   class="group flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                                    <i class="<?php echo e($social['icon']); ?> text-<?php echo e($social['color']); ?> text-xl"></i>
                                    <span class="font-medium text-gray-700 group-hover:text-blue-600 transition"><?php echo e($social['text']); ?></span>
                ...
                <div class="bg-gradient-to-b from-blue-600 to-indigo-700 p-8 lg:p-12 relative">
                    ...
                    <div class="relative mx-auto max-w-xs">
                        ...
                        <div class="relative rounded-3xl overflow-hidden border-4 border-white/20 shadow-2xl aspect-square">
                            <?php if(File::exists(public_path('media/profile/alfiq.jpg')) ||
                                ...
                                <img src="<?php echo e(asset('media/profile/alfiq.jpg')); ?>"
                                     onerror="this.onerror=null; this.src='<?php echo e(asset('media/profile/alfiq.png')); ?>'"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <?php $__currentLoopData = [
                                ...
                                <div class="flex items-center gap-3 px-4 py-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition group">
                                    <i class="<?php echo e($tech['icon']); ?> text-<?php echo e($tech['color']); ?> text-lg"></i>
                                    <span class="text-white/90 text-sm font-medium"><?php echo e($tech['text']); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
