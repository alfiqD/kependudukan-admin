  ...
  <style>
    * {
    ...
    .login-wrapper {
      ...
      width: 100%;
      max-width: 1100px;
      min-height: 520px; /* DIKURANGI dari 620px */
      background: white;
      border-radius: 20px;
      overflow: hidden;
    ...
    .slide {
      ...
      width: 100%;
      height: 100%;
      object-fit: cover; /* Kembali ke cover, tapi dengan penyesuaian */
    ...
    .right-section {
      flex: 0 0 45%;
      padding: 40px 40px; /* DIKURANGI padding */
      display: flex;
    ...
    .mb-3 {
      margin-bottom: 18px !important; /* DIKURANGI */
    }

    .mb-4 {
      margin-bottom: 22px !important; /* DIKURANGI */
    }
    ...
    @media (max-width: 992px) {
      .login-wrapper {
        flex-direction: row;
        max-width: 900px;
        min-height: 480px; /* DIKURANGI */
      }

      .right-section {
        padding: 35px 30px; /* DIKURANGI */
      }
    ...
    @media (max-width: 768px) {
      ...
      .left-section {
        height: 240px; /* DIKURANGI */
        flex: unset;
      }

      .right-section {
        flex: unset;
        padding: 35px 25px; /* DIKURANGI */
      }
  ...
  <div class="right-section">
    ...
    <form method="POST" action="/auth/login">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="username" class="form-control" placeholder="Masukkan username" value="<?php echo e(old('username')); ?>" required>
      </div>

      <div class="mb-3">
        <label class="form-label">Email</label>
        <input type="email" name="email" class="form-control" placeholder="Masukkan email" value="<?php echo e(old('email')); ?>" required>
      </div>
...
<?php /**PATH C:\alfiqlaravel\laragon-6.0-minimal\www\kependudukan-admin\resources\views/pages/auth/login-form.blade.php ENDPATH**/ ?>